...
export enum ErrorCode {
  ...
  AGENT_NO_ZONE_ASSIGNED = 'AGENT_NO_ZONE_ASSIGNED',
  AGENT_ZONE_NOT_ASSIGNED_TO_AGENT = 'AGENT_ZONE_NOT_ASSIGNED_TO_AGENT',
  ...
  COMMERCANT_NOT_IN_AGENT_ZONE = 'COMMERCANT_NOT_IN_AGENT_ZONE',
}
